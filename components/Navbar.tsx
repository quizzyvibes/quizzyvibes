...
const Navbar: React.FC<NavbarProps> = ({ user, onLogout, currentView, onChangeView }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-blue-900/50 bg-[#020617]/90 backdrop-blur-md">
      <div className="container mx-auto px-4 h-24 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 transform rotate-3">
        ...
        <div className="flex bg-slate-900/60 rounded-xl p-1.5 border border-slate-800 gap-1.5 items-center flex-shrink-0">
            ...
            <div className="flex items-center justify-center px-1">
                {user.avatar ? (
                  ...
                  <div className="w-8 h-8 rounded-full bg-indigo-500/30 flex items-center justify-center text-sm font-bold text-indigo-300 border border-indigo-500/20 shadow-inner">
            ...
            <button
               onClick={onLogout}
               className="flex-shrink-0 flex items-center justify-center w-9 h-9 rounded-lg text-slate-300 hover:text-red-400 hover:bg-red-500/10 transition-all border border-transparent hover:border-red-500/20"
               title="Log Out"
             >
               <LogOut size={18} />
            </button>
